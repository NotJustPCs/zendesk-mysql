...
class RepeatingInvoiceLineItems extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('xero_repeating_invoice_line_items', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('xero_repeating_invoice_line_items');
    }
}
