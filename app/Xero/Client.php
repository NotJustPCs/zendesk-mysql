...
use App\Exceptions\XeroException;
...
class Client
{
    ...
    private function createExceptionFromResponse(ResponseInterface $response): XeroException
    {
        ...
        return new XeroException($message, $code);
    }
